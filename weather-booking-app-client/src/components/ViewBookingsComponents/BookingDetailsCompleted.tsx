...
import { chevronBackOutline, thumbsUpSharp, thumbsDownSharp, arrowForwardOutline } from "ionicons/icons";
        ...
        <IonCardContent>
          <div className="booking-details-content">
            <div className="booking-details-details">
              <IonCardTitle className="booking-details-details__title">{props.data.location}</IonCardTitle>
              ...
              <p className="booking-details-details__weather">{props.data.weather}</p>
            </div>
          ...
          <IonCard className="enjoy-weather-card" id="feedback-card">
            ...
            <div className="thumb-group">
              ...
              <IonButton className="thumb-button invisible-button" onClick={() => handleThumbDownClick()}>
                <IonIcon icon={thumbsDownSharp} className={`${thumbUp === false ? "thumb-selected" : ""}`}></IonIcon>
              </IonButton>
            </div>
          </IonCard>
